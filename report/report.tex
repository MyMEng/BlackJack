...
\begin{abstract}
This paper reviews most common algorithms used by \emph{BlackJack}\footnote{For more details see:\\http://en.wikipedia.org/wiki/Blackjack} player to increase \emph{house edge}\footnote{A statistical advantage in favour of the house(casino) in the game.}.\\
\end{abstract}
